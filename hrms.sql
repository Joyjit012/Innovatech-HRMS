...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 04, 2026 at 06:49 AM
...
--
ALTER TABLE `employee_profile`
  ADD CONSTRAINT `fk_employee_profile_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
